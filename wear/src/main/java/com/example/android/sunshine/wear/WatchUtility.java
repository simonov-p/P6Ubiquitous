...
/**
 * Created by petr on 07-Dec-15.
 */
public class WatchUtility {

    private static final String TAG = WatchUtility.class.getSimpleName();
                ...
                new ResultCallback<NodeApi.GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(WatchUtility.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
        ...
        fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        WatchUtility.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
